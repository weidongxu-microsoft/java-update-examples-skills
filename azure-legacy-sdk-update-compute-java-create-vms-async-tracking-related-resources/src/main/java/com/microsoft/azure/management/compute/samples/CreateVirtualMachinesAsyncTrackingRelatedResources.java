...
public final class CreateVirtualMachinesAsyncTrackingRelatedResources {
    ...
    public static boolean runSample(Azure azure) {
        ...
        final String resourceGroupName = String.format("vmAsyncTrackingResources-%d", System.currentTimeMillis());
        ...
        try {
            ...
            for (int i = 0; i < desiredVMCount; i++) {
                ...
                String networkName = String.format("vmAsyncNetwork-%d", i);
                ...
                String pipName = String.format("vmAsyncPip-%d", i);
                ...
                String nicName = String.format("vmAsyncNic-%d", i);
                ...
                String availabilitySetName = String.format("vmAsyncAvailabilitySet-%d", i);
                ...
                String vmName = String.format("vmAsyncVm-%d", i);
